...
import {
  ...
  createPortfolioSchemaType,
} from "@/schema/createPortfolio";
    ...
    <Sheet open={open} onOpenChange={openChangeWrapper}>
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>
            Portfolios are a way to group your records
          </SheetDescription>
        </SheetHeader>
        <Form {...form}>
          <form
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Select a color for your portfolio
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
        ...
        <div className="flex flex-col gap-3 mt-4">
          ...
          <Button
            ...
            className={cn(
              form.watch("color") &&
                PortfolioColors[form.getValues("color") as PortfolioColor]
            )}
