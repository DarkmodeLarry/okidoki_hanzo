  ...
  return (
    <>
      ...
      >
        ...
        >
          <ChevronsDownUp className='shrink-0 w-4 h-4 ml-2 opacity-50' />
        </button>
      </div>
      {groupedOptions.length > 0 ? (
        <ul
          {...getListboxProps()}
          style={widthStyle}
          className='border-slate-100 text-slate-700 dark:border-slate-800 dark:bg-slate-800 dark:text-slate-400 absolute z-10 p-2 bg-white border rounded-md shadow-md'
        >
