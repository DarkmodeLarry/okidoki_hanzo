  ...
  return (
    ...
    >
      <ToggleGroup.Root
        ...
        className='md:flex-row md:items-center md:justify-between md:gap-0 flex flex-col gap-3 my-2'
        type='single'
        value={planSelected}
      ...
      >
        ...
        >
          ...
          <div className='-top-1 md:top-0 relative flex flex-col items-start'>
            <p className='font-semibold text-white'>Arcade</p>
            <p className='text-sm'>{yearly ? '$90/yr' : '$9/mo'}</p>
            {yearly && <span className='text-sm text-white'>2 months free</span>}
          </div>
        </ToggleGroup.Item>
        <ToggleGroup.Item
          value='advanced'
      ...
      <div className='bg-neutral-900 flex items-center justify-center w-full p-3 rounded-md'>
        <div className='flex items-center gap-6'>
          <Label htmlFor='airplane-mode' className={yearly ? '' : 'text-[#77f6aa]'}>
            Monthly
          </Label>
          <Switch
            id='airplane-mode'
